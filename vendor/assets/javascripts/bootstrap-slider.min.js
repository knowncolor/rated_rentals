!function (a) {
    ...
    var e = {formatInvalidInputErrorMsg: function (a) {
        ...
        var d = this.element = a(b).hide(), e = d.outerWidth(), f = !1, g = this.element.parent();
        ...
        ["min", "max", "step", "value"].forEach(function (a) {
            this[a] = d.data("slider-" + a) || c[a] || d.prop(a)
    ...
    f.prototype = {constructor: f, over: !1, inDrag: !1, showTooltip: function () {
        ...
        return this.layout(), this.element.trigger({type: "slideStop", value: b}).data("value", b).prop("value", b), !1
