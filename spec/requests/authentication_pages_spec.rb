...
describe "AuthenticationPages" do
  ...
  describe "signin" do
    ...
    describe "with valid information" do
      ...
      describe "already logged in use" do
        before { valid_signin(user, no_capybara: true) }

        describe "using a 'new' user action" do
          before { get new_user_path }
          specify { response.should redirect_to(user_path(user)) }
        end

        describe "using a 'create' user action" do
    ...
    describe "for non-signed-in users" do
      ...
      describe "when trying to visit a protected page" do
        ...
        describe "after signing in" do
          it "should have forwarded to the originally intended page" do
            expect(page).to have_title('Edit user')
          end

          describe "requesting a new page" do
            before { visit users_path }

            it "should have not have forwaded the user" do
      ...
      describe "in the Users controller" do
        ...
        describe "submitting to the update action" do
          ...
          specify { flash[:notice].should =~ /sign in/i }
        end
      end
    end
